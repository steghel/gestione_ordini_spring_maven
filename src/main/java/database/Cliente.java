...
public class Cliente implements Serializable{
    ...
    public void setDati(){
        dati="";
        this.dati ="NOME1:"+nome1+";&nbsp &nbsp &nbsp   NOME2:"+nome2+";&nbsp &nbsp &nbsp  NOME3:"+nome3
            +";&nbsp &nbsp &nbsp CODICE FISCALE:  "+codice_fiscale+";<br> INDIRIZZO:  "+indirizzo
            +";&nbsp &nbsp &nbsp CITTA':  "+citta+";&nbsp &nbsp &nbsp PROVINCIA:  "+provincia+";&nbsp &nbsp &nbsp CAP:  "+cap+";<br> TELEFONO:  "
            +telefono+";&nbsp &nbsp &nbsp FAX:  "+fax+";&nbsp &nbsp &nbsp EMAIL:  "+email;
    } 
    ...
    public void inserisciDati()throws Exception{
         ...
         if(codice_fiscale!=""){
            String datoDaInserire = new String("insert into cliente"
                        + "(nome1,nome2,nome3,codice_fiscale,indirizzo,"
                    + "citta,provincia,telefono,fax,email,cap)"
                    + "values( ?,?,?,?,?,?,?,?,?,?,?)");
            ...
            try{
                    ...
                    pst.setString(4, codice_fiscale);
     ...
     public void cancellaDati()throws Exception{
         ...
         try{       
            ...
            String str = new String("delete from cliente where codice_fiscale=?");
            dati=str;
    ...
    public void cancellaDati1()throws Exception{
         //crea la connesione al database
         Connessione c = new Connessione();
         c.effettuaConnessione();
         try{       
            Statement st = c.getConnessione().createStatement();
            String str = new String("delete from cliente where nome1=?");
            dati=str;
            //throw new Exception("tabella : " +  dati );
            PreparedStatement pst = c.getConnessione().prepareStatement(str);
            pst.setString(1,codice_fiscale);
    ...
    public void leggiDatiEsportazione(){
         ...
         try{             
            ...
            while(rs.next()) { 
                ...
                tabella[numeroDiRiga][3]=rs.getString("codice_fiscale");
        ...
        /*
         * 
         * prova dell'arraylist
         * 
         */
        
        //scansione delle righe della tabella 
        for(int i=0;i<max+1;i++){
            for(int j=0;j<11;j++){
                //scansione 
                Console.scriviStringa(tabella[i][j]);
            }                
        }
   ...
   public void leggiDatiTabellaScrollabile()throws Exception{
         ...
         try{
            ...
            dati+=" <table id='table' class='scrollable'> <thead> <tr> "
                    ...
                    + " <td>Codice fiscale</td> <td>Indirizzo</td>  <td>Citt&agrave;</td> "
                    + " <td>Provincia</td> <td>Telefono</td>  <td>FAX</td> "
                    + " <td>Email</td> <td>CAP</td> "
                    + "</thead><tbody>";
            while(rs.next()) { 
                //cont++;
                ...
                String str4=rs.getString("codice_fiscale");
   ...
   public void cercaDato(String cf)throws Exception{
         ...
         try{       
            Statement st = c.getConnessione().createStatement();
            ResultSet rs = st.executeQuery("select * from cliente where codice_fiscale = " + "'" + cf +"'");
   ...
   /*public void cercaDato(String cf)throws Exception{
         ...
         try{       
            Statement st = c.getConnessione().createStatement();
            String str = new String("select from cliente where codice_fiscale=?");
            dati=str;
            //throw new Exception("tabella : " +  dati );
            PreparedStatement pst = c.getConnessione().prepareStatement(str);
            pst.setString(1,codice_fiscale);
