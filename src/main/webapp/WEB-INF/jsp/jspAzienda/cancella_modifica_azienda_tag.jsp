<%-- 
    Document   : cancella_modifica_azienda_tag
    Created on : 11-mag-2012, 10.47.12
    Author     : sgh
--%>
<!DOCTYPE html>
        ...
        <body>
            ...
            <div id="content">
                <form id="idForm" name="inserimentonome" method="post" action="" >
                    ...
                    <input type="hidden" name="partita_iva" id="idPartita_iva" value="nonValido">
                    ...
                    <input type="hidden" name="tipo_di_azienda" id="idTipo_di_azienda" value="nonValido">
                    ...
                    <fieldset >
                        <legend>Cancella o modifica una azienda</legend> 
                        ...
                        <div id="bottoni"></div>
                        <div id="scrittaErrore" class="etich">&nbsp<jsp:getProperty name="azienda" property="stringaErrore"  /> </div>
                    </fieldset>

                    <jsp:setProperty name="azienda" property="partita_iva" param="partita_iva" />
                    <%--<jsp:getProperty name="azienda" property="partita_iva"  />--%>
                    <c:choose>

                        <c:when test="${param.cancella!=null}">
                            <jsp:setProperty name="azienda" property="partita_iva" param="partita_iva" />

                            <% azienda.cancellaDati();%>
                        ...
                        <c:when test="${param.modifica!=null}">
                            <%-- qui il redirect funziona --%> 


                            <jsp:setProperty name="azienda" property="nome1" param="nome1" />
                            <jsp:setProperty name="azienda" property="nome2" param="nome2" />
                            <jsp:setProperty name="azienda" property="nome3" param="nome3" />
                            <jsp:setProperty name="azienda" property="partita_iva" param="partita_iva" />
                            <jsp:setProperty name="azienda" property="indirizzo" param="indirizzo" />                                  
                            <jsp:setProperty name="azienda" property="citta" param="citta" />                                 
                            <jsp:setProperty name="azienda" property="provincia" param="provincia" />                                 
                            <jsp:setProperty name="azienda" property="telefono" param="telefono" />                                 
                            <jsp:setProperty name="azienda" property="fax" param="fax" />                                 
                            <jsp:setProperty name="azienda" property="email" param="email" /> 
                            <jsp:setProperty name="azienda" property="cap" param="cap" />
                            <jsp:setProperty name="azienda" property="tipo_di_azienda" param="tipo_di_azienda" /> 
                            <c:redirect url="cancella_modifica_azienda_tag_menuModifica"/>                               
                        </c:when>
